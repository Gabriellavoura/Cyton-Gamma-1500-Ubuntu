rostopic pub -1 /shoulder_roll_position_controller/command std_msgs/Float64 -- 0 &
...
rostopic pub -1 /elbow_yaw_position_controller/command std_msgs/Float64 -- 0 &
rostopic pub -1 /wrist_pitch_position_controller/command std_msgs/Float64 -- 0 &
rostopic pub -1 /wrist_roll_position_controller/command std_msgs/Float64 -- 0 &
rostopic pub -1 /gripper_position_controller/command std_msgs/Float64 -- 0&
